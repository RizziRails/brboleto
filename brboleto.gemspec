...
Gem::Specification.new do |s|
  ...
  s.date = %q{2014-03-27}
  s.description = %q{Gem para emissão de boletos bancários em Ruby on Rails 3.x e 4.x}
  s.summary = %q{Gem para emissão de boletos bancários em Ruby on Rails 3.x e 4.x}
